...
public class Inventory {
    ...
    public void addArtifact(Artifact artifact) { if (artifact != null) artifacts.add(artifact); }
    ...
    public void accept(ArtifactVisitor visitor) {
        for (Artifact artifact : artifacts) artifact.accept(visitor);
    }
    public Inventory copy() { return new Inventory(new ArrayList<>(artifacts)); }
}